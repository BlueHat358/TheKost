...
public class GasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gas = rootView.findViewById(R.id.btn_isiUlang_gas);
        back = rootView.findViewById(R.id.content_back_gas);
    ...
    public ArrayList<model> getListContent(){
        ...
        String[] harga = getResources().getStringArray(R.array.harga_gas);
        int[] image = {
                R.drawable.gas_3kg,
                R.drawable.gas_5kg,
                R.drawable.gas_12kg
    ...
    private View.OnClickListener gasClicked = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            GasIsiFragment gasIsiFragment = new GasIsiFragment();
            fragmentTransaction.replace(R.id.content_activity, gasIsiFragment,
                    GasIsiFragment.class.getSimpleName()).commit();
        }
    };
